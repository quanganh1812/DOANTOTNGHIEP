...
<div class="signup-form">
    <form:form action="/account/signup" modelAttribute="item" method="post">
        ...
        <div class="form-group">
            <form:input type="email" class="form-control" name="Email" placeholder="Email"  path="email"/>
        ...
        <div class="form-group">
            <form:button type="submit" class="btn btn-success btn-lg btn-block">Register Now</form:button>
        </div>
        <h5>${message}</h5>
    </form:form>
